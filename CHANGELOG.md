...
2026-08-23 - Follow Lightroom renames: an event records which collection it came from, takes its new name while nobody here has renamed it, and keeps yours the moment you do. Offer the duplicate events that renaming used to leave behind. Fix a raw and its JPEG being reported as a missing photograph.
