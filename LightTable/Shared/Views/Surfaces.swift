...
struct Surfaces {
    ...
    struct Levels: Equatable {
        ...
        /// accent: a saturated bar sitting a few inches from the photographs is
        /// a colour cast in the corner of the eye.
        ...
        var ordered: [Double] { [loupe, rail, mat, table, header, selection] }
    }
    ...
    var selection: Color { Color(white: levels.selection) }
}
